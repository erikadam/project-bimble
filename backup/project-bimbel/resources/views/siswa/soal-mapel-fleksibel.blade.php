<x-guest-layout>
    {{-- Inisialisasi Alpine.js HANYA dengan variabel durasi dalam menit --}}
    <div class="py-12 bg-gray-900" x-data="ujianPageData({{ $durasi }})" x-init="init()">
    ...
    <script>
        function ujianPageData(durasiMenit) {
            return {
                ...
                init() {
                    ...
                    // Waktu selesai dihitung murni dari durasi
                    const endTime = new Date().getTime() + (durasiMenit * 60 * 1000);
